...
public class Borrower_add {
  public static void run() {
    ...
    Database database = new Database(dbUrl);
     ...
     JLabel element8 = new JLabel("ADD BORROWER");
     ...
     element14.setBounds(307, 290, 106, 29);
     ...
     element14.addActionListener(new ActionListener() {
      @Override
      public void actionPerformed(ActionEvent e) {
        String card_id = element15.getText();
        String name = element16.getText();
        String book_id = element17.getText();
        String date_borrowed = element19.getText();
        String date_return = element20.getText();
        FileHandler.writeLog("USER CLICKED THE SAVE BUTTON");
        database.addBorrower(Integer.parseInt(card_id), name, Integer.parseInt(book_id), date_borrowed, date_return, "Borrowed");
        JOptionPane.showMessageDialog(frame, "ADDED SUCCESFULY", "NOTIFICATION", JOptionPane.INFORMATION_MESSAGE);
