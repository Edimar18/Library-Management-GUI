...
public class Search_books_byAuthor {
  public static void run() {
    ...
    Database database = new Database(dbUrl);
     ...
     JLabel element10 = new JLabel("SEARCH BY AUTHOR");
     element10.setBounds(53, 88, 145, 15);
     ...
     element11.setBounds(214, 85, 190, 23);
     ...
     element12.setBounds(436, 80, 106, 29);
     ...
     element12.addActionListener(new ActionListener() {
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        String Author = element11.getText();
        ResultSet records = database.displayBookByAuthor(Author);
